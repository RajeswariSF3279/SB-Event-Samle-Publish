...
window.sfBlazor.HeatMap = function () {
  ...
  function () {
    ...
    SfHeatMap.prototype.initialize = function (property) {
      ...
      sf.base.EventHandler.add(window, resize, this.resizeBound.bind(this), this); // Variables that hold the client rect values of the X Axis, Y Axis, Legend, Title and Heatmap element.

      var availableSize = this.getElementBounds(this.element);
      var xAxisSize = this.getMaxLabelSize(property.XAxisLabels, property.XAxisTextStyles);
      var yAxisSize = this.getMaxLabelSize(property.YAxisLabels, property.YAxisTextStyles);
      var titleSize = this.getMaxLabelSize([property.TitleText], property.TitleStyle);
      var legendTextSize = this.getMaxLabelSize(property.LegendLabels, property.LegendTextStyle);
  ...
  var HeatMap = {
    initialize: function initialize(element, dotnetRef, property) {
      ...
      return element && element.blazorInstance ? element.blazorInstance.initialize(property) : null;
    },
