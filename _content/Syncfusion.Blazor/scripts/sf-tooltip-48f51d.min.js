  ...
  var Tooltip = {
    ...
    showTooltip: function showTooltip(element, target, animation, targetProp) {
      ...
      if (targetProp !== null && targetProp !== '') {
        var isInlineTarget = sf.base.select(targetProp, element.blazor__instance.element);
    ...
    updateProperties: function updateProperties(element, completeProps, props) {
      ...
      if (props.target || props.opensOn || !sf.base.isNullOrUndefined(props.isSticky)) {
        blazInstance.unwireEvents(blazInstance.properties.opensOn);
        ...
        if (props.container) {
          ...
          if (blazInstance.tooltipEle && target) {
            blazInstance.appendContainer();
