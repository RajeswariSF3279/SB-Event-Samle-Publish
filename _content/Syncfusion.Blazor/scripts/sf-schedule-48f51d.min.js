...
window.sfBlazor.Schedule = function () {
  ...
  function () {
    ...
    EventBase.prototype.eventClick = function (eventData) {
      ...
      if (target.classList.contains(DRAG_CLONE_CLASS) || target.classList.contains(RESIZE_CLONE_CLASS) || target.classList.contains(BLOCK_APPOINTMENT_CLASS) || target.classList.contains(INLINE_SUBJECT_CLASS)) {
        return;
      }
    ...
    EventBase.prototype.allDayExpandScroll = function (dateHeader) {
      ...
      if (this.parent.uiStateValues.expand && (content.offsetWidth - content.clientWidth > 0 || this.parent.element.classList.contains(DEVICE_CLASS))) {
    ...
    Resize.prototype.horizontalResizing = function (isLeft) {
      ...
      if (this.parent.isTimelineView()) {
        ...
        if (['Year', 'Month', 'Week', 'Date'].indexOf(headerName) !== -1) {
          ...
          cellIndex = isLeft ? Math.floor(this.actionObj.clone.offsetLeft / this.actionObj.cellWidth) : Math.ceil((this.actionObj.clone.offsetLeft + (this.actionObj.clone.getBoundingClientRect().width - cellWidth)) / this.actionObj.cellWidth);
          ...
          if (this.parent.options.enableRtl) {
            ...
            var offsetWidth = Math.floor(parseInt(this.actionObj.clone.style.right, 10) / this.actionObj.cellWidth) * this.actionObj.cellWidth + (isLeft ? 0 : this.actionObj.clone.getBoundingClientRect().width - cellOffsetWidth);
        ...
        if (['TimelineMonth', 'Year', 'Month', 'Week', 'Date'].indexOf(headerName) !== -1 || !this.parent.activeViewOptions.timeScale.enable) {
          ...
          if (!isLeft) {
            offsetValue += this.actionObj.clone.getBoundingClientRect().width;
          }
  ...
  function () {
    ...
    SfSchedule.prototype.createQuickPopup = function (guid, isServerBinding, isPrevent) {
      ...
      if (!sf.base.isNullOrUndefined(guid)) {
        ...
        if (this.element.querySelectorAll('.e-appointment[data-guid="' + guid + '"]').length > 1 && !sf.base.isNullOrUndefined(this.activeEventData.element) && this.activeEventData.element.getAttribute('data-guid') === guid) {
