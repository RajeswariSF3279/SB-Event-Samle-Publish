...
window.sfBlazor.Treemap = function () {
  ...
  var Treemap = {
    ...
    updateProperty: function updateProperty(element, property) {
      if (element && element.blazor__instance) {
        element.blazor__instance.enableDrillDown = property.enableDrillDown;
        element.blazor__instance.levelCount = property.levelCount;
      }
    },
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
