...
var extended = {
      ...
      if (templateId != null) {
        ...
        for (var z = 0; z < templates.length; z++) {
          ...
          for (var i = 0; i < innerTemplates.length; i++) {
            ...
            var tempElements = document.querySelectorAll("#" + tempId);
            ...
            for (var k = 0; k < tempElements.length; k++) {
              ...
              if (tempElement && innerTemplates[i].children.length) {
                if (tempElement.children.length == 0) {
                  for (var j = 0; j < innerTemplates[i].children.length; j++) {
  ...
  requestHandler: function requestHandler(jsonObject) {
    try {
      ...
      } else if (currentElement && currentElement.ej2_instances.length == 0) {
