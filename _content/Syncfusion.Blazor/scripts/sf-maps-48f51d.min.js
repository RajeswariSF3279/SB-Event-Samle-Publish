...
window.sfBlazor.Maps = function () {
  ...
  function () {
    ...
    SfMaps.prototype.mouseUp = function (event) {
      ...
      if (!(id.indexOf('_Zooming_') > -1) && event.type !== 'mouseleave' && !this.isPinchZoomed && !sf.base.isNullOrUndefined(this.dotNetRef)) {
    ...
    SfMaps.prototype.mouseMove = function (event) {
      ...
      if (this.legendType === 'Interactive' && id.indexOf('_MapAreaBorder') > -1 && !sf.base.isNullOrUndefined(this.dotNetRef)) {
      ...
      if (this.legendType === 'Interactive' && id.indexOf('_LayerIndex') > -1 && !sf.base.isNullOrUndefined(this.dotNetRef)) {
    ...
    SfMaps.prototype.mouseDown = function (event) {
      ...
      if (this.isTouch && id.indexOf('MarkerIndex') > -1 && !(id.indexOf('cluster') > -1) && !sf.base.isNullOrUndefined(this.dotNetRef)) {
        var layerIndex = parseInt(id.split('_LayerIndex_')[1].split('_')[0], 10);
        var markerIndex = parseInt(id.split('_MarkerIndex_')[1].split('_')[0], 10);
        var dataIndex = parseInt(id.split('_dataIndex_')[1].split('_')[0], 10);
                ...
                for (var m = 0; m < currentEle.childElementCount; m++) {
                  ...
                  for (var k = 0; k < currentGroup.childElementCount; k++) {
                    if (currentGroup.children[k]['id'] !== '') {
                      ...
                      var lineIndex = parseInt(currentGroup.children[k].id.split('_NavigationIndex_')[1].split('_')[0], 10);
              ...
              if (currentEle.id.indexOf('Polygon') > -1 || currentEle.id.indexOf('_line_Group') > -1) {
                ...
                for (var k = 0; k < currentEle.children.length; k++) {
                  if (!sf.base.isNullOrUndefined(currentEle.children[k].id)) {
                    this.markerTranslate(currentEle.children[k], factor, x, y, this.scaleFactor, false);
                  }
                }
                ...
                for (var k = 0; k < currentEle.children.length; k++) {
                  this.dataLabelTranslate(currentEle.children[k], factor, x, y, this.scaleFactor, 'DataLabel');
                }
              }
            }
          }
    ...
    SfMaps.prototype.markerTemplateTranslate = function (templateCollection, factor, x, y) {
      if (templateCollection) {
        for (var k = 0; k < templateCollection.childElementCount; k++) {
          this.markerTranslate(templateCollection.children[k], factor, x, y, this.scaleFactor, true);
        }
      }
    };
  ...
  var Maps = {
    getMarker: function getMarker(target, options, element) {
      if (element && element.blazor__instance) {
        element.blazor__instance.clusterExpand(target, options);
      }
    },
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 3:
              ...
              return [4
              /*yield*/
              , this.dotNetRef.invokeMethodAsync('ZoomMarker', layerIndex, markerIndex, dataIndex, 0, 0, scale)];
    ...
    markerAnimation: function markerAnimation(id, marker, element) {
      if (element && element.blazor__instance) {
        element.blazor__instance.markerAnimation(id, marker);
      }
    },
    layerAnimation: function layerAnimation(id, point, scale, currentPoint, currentScale, element) {
      if (element && element.blazor__instance && id !== element.id) {
        ...
        for (var i = 0; i < layerGroup.children.length; i++) {
          if (layerGroup.children[i].getAttribute('transform') !== null) {
            this.zoomAnimation(layerGroup.children[i], 0, 1000, currentPoint, currentScale, point, scale);
          }
        }
      }
    },
    ...
    zoomAnimation: function zoomAnimation(element, delay, duration, currentPoint, scale, previousLocation, preScale) {
      var _this = this;
    ...
    bubbleAnimation: function bubbleAnimation(id, bubble, element) {
      if (element && element.blazor__instance) {
        element.blazor__instance.bubbleAnimation(id, bubble);
      }
    },
