...
window.sfBlazor.DashboardLayout = function () {
  ...
  function () {
    ...
    SfDashboardLayout.prototype.initialize = function (property) {
      ...
      this.bindEvents(); // Defines the offset height and width of the parent element.

      var parentOffset = this.calculateCellSize(); // Defines the id and header height of the panel.
  ...
  var DashboardLayout = {
    initialize: function initialize(element, dotnetRef, property) {
      ...
      return this.isValid(element) ? element.blazorInstances.initialize(property) : null;
    },
